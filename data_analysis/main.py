...
# Add the project root (parent of common_code) to sys.path
project_root = Path.cwd().resolve().parent
sys.path.append(str(project_root / "data_analysis"))

from data_analysis.compute_f import split_ts_seq, compute_step_positions
from data_analysis.io_f import read_data_file
from data_analysis.visualize_f import visualize_trajectory, visualize_heatmap, save_figure_to_html
